...
3) Run `./hack/development-mode.sh`, this will create new branch based on your current branch with name `<current-branch>-dev`, add commit with updates of argo-cd to your fork and applies configuration for argo-cd.
